...
let rawData = require('../config/rawData.json');
...
class RoomTime extends Component {
  ...
  componentDidMount(){
    let myCharts=echarts.init(document.getElementById('canva'));
    const option = this.makeOption(rawData)
  ...
  render() {
    return (
      <div className="room-time-bg global-content">
        <h1>room time</h1>
        <div id="canva" style={{ height: '500px', width: '1200px'}}></div>
