      ...
      <div className="classroom-bg global-content">
        <Switch>
          ...
          <Route path="/classroom/list">
            <div>
              <Link to="/classroom/create" className="fl btn-add">新增教室</Link>
              <TableList
                data={tempData}
                prefixUrl="/classroom/edit/"
                tableData={roomData}
                isDialogOpen={true}
          ...
          {/* 教室細項 */}
          <Route exact path="/classroom/detail/:courseId">
            <CourseDetail
              detail={courseDetail}
          ...
          {/* 教室編輯 */}
          <Route exact path="/classroom/edit/:courseId">
          </Route>
