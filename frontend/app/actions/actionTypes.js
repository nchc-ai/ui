...
export const GET_COURSE_LIST = ['GET_COURSE_LIST_LOADING', 'GET_COURSE_LIST_SUCCESS', 'GET_COURSE_LIST_FAIL'];
export const CREATE_COURSE = ['CREATE_COURSE_LOADING', 'CREATE_COURSE_SUCCESS', 'CREATE_COURSE_FAIL'];
